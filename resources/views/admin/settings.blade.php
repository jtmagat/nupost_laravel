        ...
        <div class="sp" id="account">
            ...
            <div class="sp__body">
                ...
                <div style="display:flex;align-items:center;gap:18px;margin-bottom:24px;padding-bottom:20px;border-bottom:1.5px solid var(--card-border);">
                    ...
                    <div>
                        <div style="font-size:16px;font-weight:700;color:var(--ink);">Administrator</div>
                        <div style="font-size:13px;color:var(--ink-soft);margin-top:2px;">admin@nupost.com</div>
                ...
                <div class="field-row">
                    <div class="field"><label>Name</label><input type="text" value="Administrator" readonly></div>
                    <div class="field"><label>Email Address</label><input type="email" value="admin@nupost.com" readonly><div class="field-hint">Admin credentials are managed in system configuration.</div></div>
                </div>
        ...
        <div class="sp" id="security">
            ...
            <div class="sp__body">
                <div style="background:var(--navy-pale);border:1.5px solid rgba(0,35,102,0.15);border-radius:12px;padding:14px 18px;margin-bottom:20px;font-size:13px;color:var(--navy);display:flex;align-items:flex-start;gap:10px;">
                    ...
                    <div>Admin credentials are hardcoded in <strong>LoginController.php</strong>. Update the <code style="background:rgba(0,35,102,0.08);padding:1px 6px;border-radius:4px;">admin_password</code> value to change credentials.</div>
                </div>
                <div class="field-row">
                    <div class="field"><label>Current Password</label><input type="password" value="admin123" readonly></div>
                    <div class="field"><label>Email</label><input type="email" value="admin@nupost.com" readonly></div>
                </div>
                <p style="font-size:12.5px;color:var(--ink-soft);margin-top:4px;">Edit <code style="background:var(--cream-dark);padding:2px 6px;border-radius:4px;font-size:12px;">app/Http/Controllers/Auth/LoginController.php</code> to update credentials.</p>
            </div>
        </div>
